    ...
    <div class="container p-4 pb-0">
      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
			Want to be the first to know about our new launches & get offers? Be our friend and put your email ID below :)
            </p>
      ...
      <p><i class="fas fa-envelope mr-3"></i> getpets@gmail.com</p>
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
            <h6 class="text-uppercase mb-4 font-weight-bold">Shop Online</h6>
            <p>
              <a class="text-white">Dogs</a>
            </p>
            <p>
